...
Here's what you'll find:
    ...
    3rdPartyCredits        - Acknowledgements for 3rd party contributions 
                             to the LPS.
    lps-4.2.x        - Expanded directory containing the 
                             LPS 4.2.x web app.
    release-notes.html     - Release notes.

Deploy the lps-4.2.x web application and surf to 

       http://yourhost:yourport/lps-4.2.x/index.html
...
OpenLaszlo 4.2.x Latest trunk@13259 (13260) 2009-03-12T08:15:10Z
