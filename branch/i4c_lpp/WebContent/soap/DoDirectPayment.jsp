...
<br><br>
<form method="POST" action="DirectPaymentReceipt.jsp" name="frmDCC">
...
<table width=600>
	...
	<tr>
		...
		<td align=left><input type=text size=19 maxlength=19 value = 4336221215845180 name=creditCardNumber></td>
	</tr>
	<tr>
