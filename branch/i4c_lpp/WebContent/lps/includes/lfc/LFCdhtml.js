...
if(!$2.__LZdeleted){
var $lzsc$1711064402="$lzc$set_"+$3;if(Function["$lzsc$isa"]?Function.$lzsc$isa($2[$lzsc$1711064402]):$2[$lzsc$1711064402] instanceof Function){
$2[$lzsc$1711064402]($5)
}else{
$2[$3]=$5;var $lzsc$2058814735=$2["on"+$3];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$2058814735):$lzsc$2058814735 instanceof LzEvent){
if($lzsc$2058814735.ready){
$lzsc$2058814735.sendEvent($5)
...
if(!this.__LZdeleted){
var $lzsc$1468359970="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$1468359970]):this[$lzsc$1468359970] instanceof Function){
this[$lzsc$1468359970]($6)
}else{
this[$1]=$6;var $lzsc$1874056644=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1874056644):$lzsc$1874056644 instanceof LzEvent){
if($lzsc$1874056644.ready){
$lzsc$1874056644.sendEvent($6)
...
var $lzsc$1330575480="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$1330575480]):this[$lzsc$1330575480] instanceof Function){
this[$lzsc$1330575480]($6)
}else{
this[$1]=$6;var $lzsc$879735493=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$879735493):$lzsc$879735493 instanceof LzEvent){
if($lzsc$879735493.ready){
$lzsc$879735493.sendEvent($6)
}}}};return null
...
if(!this.__LZdeleted){
var $lzsc$102294320="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$102294320]):this[$lzsc$102294320] instanceof Function){
this[$lzsc$102294320]($3)
}else{
this[$1]=$3;var $lzsc$638983484=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$638983484):$lzsc$638983484 instanceof LzEvent){
if($lzsc$638983484.ready){
$lzsc$638983484.sendEvent($3)
...
var $2=LzSprite.__rootSpriteContainer;if($1){
$2.onmouseover()
}else{
$2.onmouseout()
...
if($3=="oncontextmenu"||$3=="onmousedown"&&$1.button==2){
...
$8.push($7,$7.style.display);var $9=$7.style.zIndex;$7.style.zIndex=-1000;var $10=canvas.sprite.__LZclickcontainerdiv;var $11=$10.style.zIndex;$8.push($10,$10.style.display);$10.style.zIndex=-9999
};do{
...
}};var $4=lz.embed.__propcache;var $5=LzSprite.__rootSpriteContainer=$4.appenddiv;$5.style.margin=0;$5.style.padding=0;$5.style.border="0 none";$5.style.overflow="hidden";if($3.fix_contextmenu){
var $6=document.createElement("div");$6.className="lzcanvascontextdiv";$6.id="lzcanvascontextdiv";$5.appendChild($6);$6.owner=this;this.__LZcontextcontainerdiv=$6
};if($4.bgcolor){
...
};lz.embed.options.approot=typeof $4.approot=="string"?$4.approot:"";$5.appendChild(div);this.__LZdiv=div;if($3.fix_clickable){
var $7=document.createElement("div");$7.className="lzcanvasclickdiv";$7.id="lzcanvasclickdiv";$5.appendChild($7);this.__LZclickcontainerdiv=$7
};if($3["css_hide_canvas_during_init"]){
var $8="display";var $9="none";if($3["safari_visibility_instead_of_display"]){
$8="visibility";$9="hidden"
};this.__LZdiv.style[$8]=$9;if($3["fix_clickable"]){
this.__LZclickcontainerdiv.style[$8]=$9
};if($3["fix_contextmenu"]){
this.__LZcontextcontainerdiv.style[$8]=$9
}};if($3.activate_on_mouseover){
$5.mouseisover=false;$5.onmouseover=function($1){
...
var $4=LzSprite.__rootSpriteContainer;if(!$4.mouseisover){
$4.onmouseover()
...
};var $lzsc$423550939=this.__LZdiv.id;if(!$2.__LZdeleted){
if(Function["$lzsc$isa"]?Function.$lzsc$isa($2["$lzc$set_for"]):$2["$lzc$set_for"] instanceof Function){
$2["$lzc$set_for"]($lzsc$423550939)
}else{
$2["for"]=$lzsc$423550939;var $lzsc$460678632=$2["onfor"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$460678632):$lzsc$460678632 instanceof LzEvent){
if($lzsc$460678632.ready){
$lzsc$460678632.sendEvent($lzsc$423550939)
...
return
};var $3=LzSprite.prototype.setWidth.call(this,$1);var $4=$1;var $5=this.scrolldiv;var $6=$5.style;var $7=this.CSSDimension;var $8=$7($4);var $9=$7(this.height);if(this.scrollevents){
$4+=this.quirks.scrollbar_width
};var $10=this.__LZtextIndent<0?-1*this.__LZtextIndent:0;if($4>=$10){
$4-=$10
};$8=$7($4);if($6.width!=$8){
$5.style.width=$8;if(this.scrollevents){
$5.style.clip="rect(0 "+$8+" "+$9+" 0)"
};this.__updatefieldsize()
};return $3
};LzTextSprite.prototype.setHeight=function($1){
if($1==null||$1<0||isNaN($1)){
return
};var $2=LzSprite.prototype.setHeight.call(this,$1);var $3=$1;var $4=this.scrolldiv;var $5=$4.style;var $6=this.CSSDimension;var $7=$6(this.width);var $8=$6($3);if(this.scrollevents){
$3+=this.quirks.scrollbar_width
};$8=$6($3);if($5.height!=$8){
$4.style.height=$6($3);if(this.scrollevents){
$4.style.clip="rect(0 "+$7+" "+$8+" 0)"
};this.__updatefieldsize()
};return $2
...
if(this[$1]){
if(!this.__LZdeleted){
var $lzsc$1934326540="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$1934326540]):this[$lzsc$1934326540] instanceof Function){
this[$lzsc$1934326540]($2)
}else{
this[$1]=$2;var $lzsc$887293596=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$887293596):$lzsc$887293596 instanceof LzEvent){
if($lzsc$887293596.ready){
$lzsc$887293596.sendEvent($2)
...
$3.update($1);var $lzsc$412582054=($4-$3.offset[$1])/$3.scale[$1];if(!this.__LZdeleted){
var $lzsc$1278806838="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$1278806838]):this[$lzsc$1278806838] instanceof Function){
this[$lzsc$1278806838]($lzsc$412582054)
}else{
this[$1]=$lzsc$412582054;var $lzsc$387246102=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$387246102):$lzsc$387246102 instanceof LzEvent){
if($lzsc$387246102.ready){
$lzsc$387246102.sendEvent($lzsc$412582054)
}}}}}else{
if($1=="width"||$1=="height"){
var $5=$1=="width"?"x":"y";$3.update($5);var $lzsc$782363500=$4/$3.scale[$5];if(!this.__LZdeleted){
var $lzsc$276884444="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(this[$lzsc$276884444]):this[$lzsc$276884444] instanceof Function){
this[$lzsc$276884444]($lzsc$782363500)
}else{
this[$1]=$lzsc$782363500;var $lzsc$793491369=this["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$793491369):$lzsc$793491369 instanceof LzEvent){
if($lzsc$793491369.ready){
$lzsc$793491369.sendEvent($lzsc$782363500)
}}}}}else{
...
var $lzsc$16216903=Number(this.from);if(!$1.__LZdeleted){
var $lzsc$1775190249="$lzc$set_"+$2;if(Function["$lzsc$isa"]?Function.$lzsc$isa($1[$lzsc$1775190249]):$1[$lzsc$1775190249] instanceof Function){
$1[$lzsc$1775190249]($lzsc$16216903)
}else{
$1[$2]=$lzsc$16216903;var $lzsc$423601163=$1["on"+$2];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$423601163):$lzsc$423601163 instanceof LzEvent){
if($lzsc$423601163.ready){
$lzsc$423601163.sendEvent($lzsc$16216903)
}}}}};if(this.relative){
this.to=this.origto
}else{
...
if(!$1.__LZdeleted){
var $lzsc$446454230="$lzc$set_"+$2;if(Function["$lzsc$isa"]?Function.$lzsc$isa($1[$lzsc$446454230]):$1[$lzsc$446454230] instanceof Function){
$1[$lzsc$446454230]($3)
}else{
$1[$2]=$3;var $lzsc$2131962228=$1["on"+$2];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$2131962228):$lzsc$2131962228 instanceof LzEvent){
if($lzsc$2131962228.ready){
$lzsc$2131962228.sendEvent($3)
...
$1[$3].c=0;var $lzsc$162671099=$1[$3].v;if(!$1.__LZdeleted){
var $lzsc$1112763947="$lzc$set_"+$2;if(Function["$lzsc$isa"]?Function.$lzsc$isa($1[$lzsc$1112763947]):$1[$lzsc$1112763947] instanceof Function){
$1[$lzsc$1112763947]($lzsc$162671099)
}else{
$1[$2]=$lzsc$162671099;var $lzsc$698085321=$1["on"+$2];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$698085321):$lzsc$698085321 instanceof LzEvent){
if($lzsc$698085321.ready){
$lzsc$698085321.sendEvent($lzsc$162671099)
}}}};$1[$3].v=null
};this.__LZhalt()
...
var $2=this.target;var $3=this.attribute;var $4=$1-this.currentValue;var $lzsc$1817163532=$2[$3]+$4;if(!$2.__LZdeleted){
var $lzsc$581920635="$lzc$set_"+$3;if(Function["$lzsc$isa"]?Function.$lzsc$isa($2[$lzsc$581920635]):$2[$lzsc$581920635] instanceof Function){
$2[$lzsc$581920635]($lzsc$1817163532)
}else{
$2[$3]=$lzsc$1817163532;var $lzsc$1262227526=$2["on"+$3];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1262227526):$lzsc$1262227526 instanceof LzEvent){
if($lzsc$1262227526.ready){
$lzsc$1262227526.sendEvent($lzsc$1817163532)
}}}};this.currentValue=$1
},"toString",function(){
...
this.__LZuserData={}};var $4=this.__LZuserData[$1];if($4!=null){
$4=$4[0]
};if($2!=null){
this.__LZuserData[$1]=[$2,$3]
}else{
...
var $2=this.__LZuserData[$1];return $2!=null?$2[0]:null
...
if(!$6.__LZdeleted){
var $lzsc$178319365="$lzc$set_"+$7;if(Function["$lzsc$isa"]?Function.$lzsc$isa($6[$lzsc$178319365]):$6[$lzsc$178319365] instanceof Function){
$6[$lzsc$178319365]($8)
}else{
$6[$7]=$8;var $lzsc$228563636=$6["on"+$7];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$228563636):$lzsc$228563636 instanceof LzEvent){
if($lzsc$228563636.ready){
$lzsc$228563636.sendEvent($8)
}}}}}};return $4
},"unregisterAll",function(){
...
$2.spacing=0
};this.totalsize=this.viewsize+$2.spacing;var $lzsc$850044376=this.axis;var $lzsc$1116843973=this.totalsize;if(!$7.__LZdeleted){
var $lzsc$689278333="$lzc$set_"+$lzsc$850044376;if(Function["$lzsc$isa"]?Function.$lzsc$isa($7[$lzsc$689278333]):$7[$lzsc$689278333] instanceof Function){
$7[$lzsc$689278333]($lzsc$1116843973)
}else{
$7[$lzsc$850044376]=$lzsc$1116843973;var $lzsc$1139856582=$7["on"+$lzsc$850044376];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1139856582):$lzsc$1139856582 instanceof LzEvent){
if($lzsc$1139856582.ready){
$lzsc$1139856582.sendEvent($lzsc$1116843973)
...
var $lzsc$788659239=$8*$7-this.spacing;if(!$3.__LZdeleted){
var $lzsc$862449080="$lzc$set_"+$6;if(Function["$lzsc$isa"]?Function.$lzsc$isa($3[$lzsc$862449080]):$3[$lzsc$862449080] instanceof Function){
$3[$lzsc$862449080]($lzsc$788659239)
}else{
$3[$6]=$lzsc$788659239;var $lzsc$1545664654=$3["on"+$6];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1545664654):$lzsc$1545664654 instanceof LzEvent){
if($lzsc$1545664654.ready){
$lzsc$1545664654.sendEvent($lzsc$788659239)
...
this.clones[$16]=$17;var $lzsc$3485174=($16+$9)*$7;if(!$17.__LZdeleted){
var $lzsc$1819808916="$lzc$set_"+$5;if(Function["$lzsc$isa"]?Function.$lzsc$isa($17[$lzsc$1819808916]):$17[$lzsc$1819808916] instanceof Function){
$17[$lzsc$1819808916]($lzsc$3485174)
}else{
$17[$5]=$lzsc$3485174;var $lzsc$1943940286=$17["on"+$5];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1943940286):$lzsc$1943940286 instanceof LzEvent){
if($lzsc$1943940286.ready){
$lzsc$1943940286.sendEvent($lzsc$3485174)
...
};this.clones[$15]=$23;var $lzsc$1552032583=this.axis;if(!$23.__LZdeleted){
var $lzsc$85891883="$lzc$set_"+$lzsc$1552032583;if(Function["$lzsc$isa"]?Function.$lzsc$isa($23[$lzsc$85891883]):$23[$lzsc$85891883] instanceof Function){
$23[$lzsc$85891883]($24)
}else{
$23[$lzsc$1552032583]=$24;var $lzsc$877351748=$23["on"+$lzsc$1552032583];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$877351748):$lzsc$877351748 instanceof LzEvent){
if($lzsc$877351748.ready){
$lzsc$877351748.sendEvent($24)
}}}};var $17=$16.__LZgetSize(this.datasizevar);var $18=$17==null?this.viewsize:$17;if($23[this.sizeAxis]!=$18){
var $lzsc$972104218=this.sizeAxis;if(!$23.__LZdeleted){
var $lzsc$587052915="$lzc$set_"+$lzsc$972104218;if(Function["$lzsc$isa"]?Function.$lzsc$isa($23[$lzsc$587052915]):$23[$lzsc$587052915] instanceof Function){
$23[$lzsc$587052915]($18)
}else{
$23[$lzsc$972104218]=$18;var $lzsc$668669536=$23["on"+$lzsc$972104218];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$668669536):$lzsc$668669536 instanceof LzEvent){
if($lzsc$668669536.ready){
$lzsc$668669536.sendEvent($18)
}}}}};$24+=$18+this.spacing
};this.__LZdataoffset=$6;var $lzsc$348685452=this.cloneimmediateparent;var $lzsc$1367721977=this.sizeAxis;if(!$lzsc$348685452.__LZdeleted){
var $lzsc$1073048601="$lzc$set_"+$lzsc$1367721977;if(Function["$lzsc$isa"]?Function.$lzsc$isa($lzsc$348685452[$lzsc$1073048601]):$lzsc$348685452[$lzsc$1073048601] instanceof Function){
$lzsc$348685452[$lzsc$1073048601]($10)
}else{
$lzsc$348685452[$lzsc$1367721977]=$10;var $lzsc$2107783110=$lzsc$348685452["on"+$lzsc$1367721977];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$2107783110):$lzsc$2107783110 instanceof LzEvent){
if($lzsc$2107783110.ready){
$lzsc$2107783110.sendEvent($10)
...
var $6=$4[$5];var $lzsc$735149852=global[$6.c];var $lzsc$1718730938=$6.n;var $lzsc$451504570=$6.v;if(!$lzsc$735149852.__LZdeleted){
var $lzsc$810680128="$lzc$set_"+$lzsc$1718730938;if(Function["$lzsc$isa"]?Function.$lzsc$isa($lzsc$735149852[$lzsc$810680128]):$lzsc$735149852[$lzsc$810680128] instanceof Function){
$lzsc$735149852[$lzsc$810680128]($lzsc$451504570)
}else{
$lzsc$735149852[$lzsc$1718730938]=$lzsc$451504570;var $lzsc$618128053=$lzsc$735149852["on"+$lzsc$1718730938];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$618128053):$lzsc$618128053 instanceof LzEvent){
if($lzsc$618128053.ready){
$lzsc$618128053.sendEvent($lzsc$451504570)
}}}}};if(!this.__LZdeleted){
if(Function["$lzsc$isa"]?Function.$lzsc$isa(this["$lzc$set_offset"]):this["$lzc$set_offset"] instanceof Function){
this["$lzc$set_offset"]($3)
}else{
this["offset"]=$3;var $lzsc$1425325342=this["onoffset"];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1425325342):$lzsc$1425325342 instanceof LzEvent){
if($lzsc$1425325342.ready){
$lzsc$1425325342.sendEvent($3)
}}}};return $3
},"receiveEvent",function($1,$2){
if(!canvas.__LZdeleted){
var $lzsc$1086433826="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(canvas[$lzsc$1086433826]):canvas[$lzsc$1086433826] instanceof Function){
canvas[$lzsc$1086433826]($2)
}else{
canvas[$1]=$2;var $lzsc$1766834772=canvas["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1766834772):$lzsc$1766834772 instanceof LzEvent){
if($lzsc$1766834772.ready){
$lzsc$1766834772.sendEvent($2)
