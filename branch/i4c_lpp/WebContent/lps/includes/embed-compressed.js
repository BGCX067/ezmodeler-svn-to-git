...
var $lzsc$908784343="$lzc$set_"+$1;if(Function["$lzsc$isa"]?Function.$lzsc$isa(canvas[$lzsc$908784343]):canvas[$lzsc$908784343] instanceof Function){
canvas[$lzsc$908784343]($2)
}else{
canvas[$1]=$2;var $lzsc$1002385147=canvas["on"+$1];if(LzEvent["$lzsc$isa"]?LzEvent.$lzsc$isa($lzsc$1002385147):$lzsc$1002385147 instanceof LzEvent){
if($lzsc$1002385147.ready){
$lzsc$1002385147.sendEvent($2)
}}}}}}},_loaded:function($1){
