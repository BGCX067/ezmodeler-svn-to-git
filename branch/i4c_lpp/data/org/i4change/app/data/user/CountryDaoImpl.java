...
//			Transaction tx = session.beginTransaction();
			...
			Long id = (Long) getSession().save(st);
...
//			Transaction tx = session.beginTransaction();
			Query query = getSession()
					.createQuery("select c from Country as c where c.country_id = :country_id AND deleted != :deleted");
...
//			Transaction tx = session.beginTransaction();
			Query query = getSession()
					.createQuery("select c from Country as c where c.paypal LIKE :paypal AND deleted != :deleted");
...
//			Transaction tx = session.beginTransaction();
			Query query = getSession()
					.createQuery("select c from Country as c where deleted != :deleted AND paypal != :paypal");
			query.setString("deleted", "true");
