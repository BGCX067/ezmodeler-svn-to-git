...
//	}
	...
	public void loadMainMenu() {
		...
		Long global_id = this.navimanagement.addGlobalStructure(
								"home", 1, 124, false, true, 1, "home");
		this.navimanagement.addMainStructure("mainDashboard", 1, 290,
				true, true, 1, "mainDashboard", global_id);

		Long global_id_mod = this.navimanagement.addGlobalStructure(
								"mod", 2, 689, false, true, 2, "admin");
		this.navimanagement.addMainStructure("modRoles", 1, 690,
				true, false, 2, "modRoles", global_id_mod);
		this.navimanagement.addMainStructure("modRoles", 2, 691,
				true, false, 2, "modStatistics", global_id_mod);
		
		Long global_id_admin = this.navimanagement.addGlobalStructure(
								"admin", 3, 6, false,true, 3, "admin");
		this.navimanagement.addMainStructure("userAdmin", 13, 125,
				true, false, 3, "userAdmin", global_id_admin);
		this.navimanagement.addMainStructure("orgAdmin", 14, 127,
				true, false, 3, "orgAdmin", global_id_admin);
		this.navimanagement.addMainStructure("confAdmin", 16, 263,
				true, false, 3, "confAdmin", global_id_admin);
		this.navimanagement.addMainStructure("languagesEditor", 17,
				348, true, false, 3, "languagesEditor", global_id_admin);
		this.navimanagement.addMainStructure("backupContent", 18, 367,
				true, false, 3, "backupContent", global_id_admin);		
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.installation.IImportInitvalues#loadErrorMappingsFromXML(java.lang.String)
	 */
	public void loadErrorMappingsFromXML(String filePath) throws Exception {
		...
		for (Iterator it = root.elementIterator("row"); it.hasNext();) {
			...
			this.errorManagement.addErrorValues(errorvalues_id,
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.installation.IImportInitvalues#loadConfiguration(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public void loadConfiguration(String crypt_ClassName,
		...
		//"smtp.xmlcrm.org"
		this.configurationmanagement.addConfByKey(3, "smtp_server",
				smtpServer, null, "this is the smtp server to send messages");
		//25
		this.configurationmanagement.addConfByKey(3, "smtp_port",
		...
		this.configurationmanagement.addConfByKey(3, "swftools_path",
				swf_path, null, "Path To SWF-Tools");

		this.configurationmanagement.addConfByKey(3,
				"imagemagick_path", im_path, null, "Path to ImageMagick tools");

		this.configurationmanagement.addConfByKey(3, "rss_feed1",
				url_feed, null, "Feed URL");

		this.configurationmanagement.addConfByKey(3, "rss_feed2",
				url_feed2, null, "Feed URL 2");
		
		this.configurationmanagement.addConfByKey(3, "sendEmailAtRegister",
				sendEmailAtRegister, null, "User get a EMail with their Account data. Values: 0(No) or 1(Yes)");
		
		this.configurationmanagement.addConfByKey(3, "sendEmailWithVerficationCode",
		...
		this.configurationmanagement.addConfByKey(3, "expireDateMonthsMax",
				"6", null, "Number of Months you can use your workdays for Pending Organizations");
		
		this.configurationmanagement.addConfByKey(3, "maxWorkDays",
				"30", null, "Number of workdays for Pending Organizations");
		
		this.configurationmanagement.addConfByKey(3, "maxUsers",
				"10", null, "Number of maxUsers for Pending Organizations");
		
		this.configurationmanagement.addConfByKey(3, "mailSpoolCheckTime",
				"10000", null, "Amount of Time in Milliseconds the Mail Spool will try to load the next Items from the Queue");
		
		this.configurationmanagement.addConfByKey(3, "mailSpoolMaxNumberOfItemsPerSpool",
				"5", null, "Number of mails which the Spool will check for Sending in one bunch");
		
		this.configurationmanagement.addConfByKey(3, "system_link_buy_license",
				"http://localhost/i4change/BuyLicense", null, "Link inside the Mails for Pending Organizations");
		
		this.configurationmanagement.addConfByKey(3, "system_link_unregister_from_list",
				"http://localhost:5080/i4change/Unregister", null, "Servlet to remove user from List of Pending Organizations");
		
		this.configurationmanagement.addConfByKey(3, "sessionClearCheckTime",
				"30000", null, "Time in MilliSeconds the Session cache will be cleared");
		
		this.configurationmanagement.addConfByKey(3, "reminderMailsPendingOrgs",
				"43200000", null, "Time in MilliSeconds the System will check for Pending Orgs to send a Reminder (86400000 == 1 Day)");
		
		
		this.configurationmanagement.addConfByKey(3, "defaultOrganizationPricing",
				"39.95", null, "default Price in USD for a Organization per Year + 1 account");
		...
		this.configurationmanagement.addConfByKey(3, "discountAmount1",
				"10", null, "default Discount Barrier one");
		
		this.configurationmanagement.addConfByKey(3, "discountNumberOfUsers2",
				"20", null, "default Pricing Barrier two");
		this.configurationmanagement.addConfByKey(3, "discountAmount2",
				"20", null, "default Discount Barrier two");
		
		this.configurationmanagement.addConfByKey(3, "maxNumberOfUser",
				"30", null, "default Discount Barrier three, values greater then that will receive a info message");
		...
		this.configurationmanagement.addConfByKey(3, "invoiceNumber",
				"0", null, "Current Invoice Number");
		
		this.configurationmanagement.addConfByKey(3, "invoiceDescriptionSingleUser",
				"i4Change License 1 Year Single User", null, "invoiceDescriptionSingleUser");
		
		this.configurationmanagement.addConfByKey(3, "invoiceDescriptionMultiUser",
				"i4Change License 1 Year Multi User", null, "invoiceDescriptionMultiUser");
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.installation.IImportInitvalues#loadInitUserAndOrganisation(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	public void loadInitUserAndOrganisation(String username, String userpass,
			String email, String defaultOrganisationName) {
		//Add user
		try {
			Long user_id = this.usermanagement.importUserInstallation(
					new Long(3), 3, 1, 1, username, userpass, "Wagner",
					"Sebastian", email, new java.util.Date(), "Bleichstra§e", "92",
					"fax", "75173", 80, "Pforzheim", 1, false, null, null);

			//Add default group
			Long organisation_id = this.organisationDaoImpl
					.addOrganisation(defaultOrganisationName, user_id);

			//Add user to default group
			this.organisationDaoImpl.addUserToOrganisation(
					new Long(1), organisation_id, null, "", false);
		} catch (Exception e) {
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.installation.IImportInitvalues#loadInitLanguages(java.lang.String)
	 */
	public void loadInitLanguages(String filePath) throws Exception {
		...
		for (Iterator it = roothelp.elementIterator("item"); it.hasNext();) {
			...
			this.helpTopicServiceDaoImpl.addHelpTopic(labelId, topicLabelId, helpId, helpName, isAgentHelpBool, priority);
