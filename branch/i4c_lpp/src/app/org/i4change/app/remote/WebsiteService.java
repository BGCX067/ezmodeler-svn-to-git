...
public class WebsiteService implements IWebsiteService {
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemById(java.lang.String, long)
	 */
	public WebItemDTO getWebItemById(String SID, long webItemId){
		try {
        	return this.morphWebItemToWebItemDTO(this.webItemDaoImpl.getWebItemById(webItemId));
		} catch (Exception err) {
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemTypes(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemSearchList(java.lang.String, int, int, java.lang.String, boolean, java.lang.Integer, java.lang.String)
	 */
	public SearchResult getWebItemSearchList(String SID, int start, int max, 
		...
		try {
	        ...
	        if (AuthLevelmanagement.checkAdminLevel(user_level)){
	        	...
	        	sResult.setRecords(this.webItemDaoImpl.getItemsSelectBySearch(search, searchOnlyHelpItems));
	        	
	        	List<WebItem> webItems = this.webItemDaoImpl.getWebItemsBySearch(start, max, orderby, asc, searchOnlyHelpItems, search);
	        	
	        	List<WebItemListDTO> webListItems = new LinkedList<WebItemListDTO>();
	        	
	        	for (int i=0;i<webItems.size();i++) {
	        		webListItems.add(this.morphWebItemToWebItemListDTO(webItems.get(i)));
	        	}
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemList(java.lang.String, int, int, java.lang.String, boolean)
	 */
	public SearchResult getWebItemList(String SID, int start, int max, String orderby, boolean asc){
		try {
	        ...
	        if (AuthLevelmanagement.checkAdminLevel(user_level)){
	        	...
	        	List<WebItem> webItems = this.webItemDaoImpl.getWebItems(start, max, orderby, asc);
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#saveOrUpdateWebItem(java.lang.String, java.util.Map)
	 */
	public Long saveOrUpdateWebItem(String SID, Map objectMap) {
		try {
	        ...
	        if (objectMap.get("orderInt").toString().length() != 0) {
	        	orderInt = Integer.parseInt(objectMap.get("orderInt").toString());
	        }
	        ...
	        if (webItemId == null || webItemId == 0 || webItemId.equals(0)) {
	        	webItemId = this.webItemDaoImpl.addWebItem(
	        			...
	        			Boolean.valueOf(objectMap.get("isMasterRoot").toString()).booleanValue(),
	        			objectMap.get("webItemLayout").toString(),
	        			Boolean.valueOf(objectMap.get("isHelpItem").toString()).booleanValue(),
	        			orderInt);
	        } else {
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#deleteWebItem(java.lang.String, java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getFrontendItems(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemsParentChilds(java.lang.String, java.lang.Long)
	 */
	public WebItemDTO getWebItemsParentChilds(String SID, Long webItemId) {
		try {
	        ...
	        if (webItem.getIsRoot()) {
		        ...
		        WebItem webitem = this.webItemDaoImpl.getWebItemById(webItemParentId);
		        
		        List<WebItem> webItems = this.webItemRelationDaoImpl.getWebItemsChilds(webItemParentId);
		        WebItemDTO webitemDTO = this.morphWebItemToWebItemDTO(webitem);
		        webitemDTO.setChilds(this.parseWebItemsToDTO(webItems));
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemsChilds(java.lang.String, java.lang.Long)
	 */
	public WebItemDTO getWebItemsChilds(String SID, Long webItemId) {
		try {
			//List<WebItem> webItems = this.webItemRelationDaoImpl.getWebItemsChilds(webItemId);
	...
	private WebItemListDTO morphWebItemToWebItemListDTO(WebItem webItem) {
		try {
			...
			webItemListDTO.getWebItemType().setWebItemTypeId(webItem.getWebItemType().getWebItemTypeId());
			webItemListDTO.getWebItemType().setTypeName(webItem.getWebItemType().getTypeName());
	...
	private WebItemDTO morphWebItemToWebItemDTO(WebItem webItem) {
		try {
        	...
        	webItemDTO.getWebItemType().setWebItemTypeId(webItem.getWebItemType().getWebItemTypeId());
        	...
        	if (webItem.getChildItems() != null) {
        		...
        		for (Iterator<WebItemRelation> iter = webItem.getChildItems().iterator();iter.hasNext();) {
        			WebItemRelation webItemRelation = iter.next();
        			WebItemRelationDTO webItemRelationDTO = new WebItemRelationDTO();
        			webItemRelationDTO.setWebItemRelationId(webItemRelation.getWebItemRelationId());
        			webItemRelationDTO.setChild_webitem_id(webItemRelation.getChild_webitem_id());
        			webItemRelationDTO.setParent_webitem_id(webItemRelation.getParent_webitem_id());
        			
        			if (webItemRelation.getChildItem() != null) {
        				WebItemMinimalDTO webItemMinimalDTO = new WebItemMinimalDTO();
        				webItemMinimalDTO.setWebItemId(webItemRelation.getChildItem().getWebItemId());
        				webItemMinimalDTO.setWebItemName(webItemRelation.getChildItem().getWebItemName());
        	...
        	if (webItem.getParentItems() != null) {
        		...
        		for (Iterator<WebItemRelation> iter = webItem.getParentItems().iterator();iter.hasNext();) {
        			WebItemRelation webItemRelation = iter.next();
        			WebItemRelationDTO webItemRelationDTO = new WebItemRelationDTO();
        			webItemRelationDTO.setWebItemRelationId(webItemRelation.getWebItemRelationId());
        			webItemRelationDTO.setChild_webitem_id(webItemRelation.getChild_webitem_id());
        			...
        			if (webItemRelation.getParentItem() != null) {
        				WebItemMinimalDTO webItemMinimalDTO = new WebItemMinimalDTO();
        				webItemMinimalDTO.setWebItemId(webItemRelation.getParentItem().getWebItemId());
        				webItemMinimalDTO.setWebItemName(webItemRelation.getParentItem().getWebItemName());
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getWebItemsFrontendByParent(java.lang.String, java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getHelpRootItems(java.lang.String)
	 */
	public List<WebItemListDTO> getHelpRootItems(String SID) {
		try {
			
			List<WebItem> helpRootItems = this.webItemDaoImpl.getHelpRootItems();
        	...
        	for (int i=0;i<helpRootItems.size();i++) {
        		...
        		WebItemListDTO webItemListDTO = this.morphWebItemToWebItemListDTO(webItem);
        		
        		Long count = this.webItemRelationDaoImpl.countWebItemsByParent(webItem.getWebItemId());
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getTreeHelpItemsByParent(java.lang.String, java.lang.Long)
	 */
	public List<WebItemListDTO> getTreeHelpItemsByParent(String SID, Long webItemId) {
		try {
			
			List<WebItemRelation> helpItemsByParent = this.webItemRelationDaoImpl.getWebItemsByParent(webItemId);
        	...
        	for (int i=0;i<helpItemsByParent.size();i++) {
        		...
        		WebItemListDTO webItemListDTO = this.morphWebItemToWebItemListDTO(webItemRelation.getChildItem());
        		
        		Long count = this.webItemRelationDaoImpl.countWebItemsByParent(webItemListDTO.getWebItemId());
        		...
        		log.debug("-1- webItemListDTO.getWebItemId() "+webItemListDTO.getWebItemId());
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getSearchHelpItems(java.lang.String, java.lang.String)
	 */
	public List<WebItemListDTO> getSearchHelpItems(String SID, String search) {
		try {
			...
			List<WebItem> helpItemsByParent = this.webItemDaoImpl.getSearchHelpItems(search);
			...
			for (int i=0;i<helpItemsByParent.size();i++) {
				...
				if (webItem.getIsRoot()) {
					...
					List<WebItem> webItemRootNodesWithPathTemp = this.webItemRelationDaoImpl.getPathToRootNode(webItem);
			...
			List<WebItem> webItemRootNodesWithPathSorted = this.checkForDuplicates(new LinkedList<WebItem>(), webItemRootNodesWithPath);
			
			log.debug("webItemRootNodesWithPath "+webItemRootNodesWithPath.size());
			
        	for (int i=0;i<webItemRootNodesWithPathSorted.size();i++) {
        		
        		WebItem webItem = webItemRootNodesWithPathSorted.get(i);
        		
        		WebItemListDTO webItemListDTO = this.morphWebItemToWebItemListDTOWithPath(webItem);
	...
	private List<WebItem> checkForDuplicates(List<WebItem> webItemRootNodesWithPathSorted, List<WebItem> webItemRootNodesWithPath) throws Exception {
		...
		for (int i=0;i<webItemRootNodesWithPath.size();i++) {
			...
			for (int k=0;k<webItemRootNodesWithPathSorted.size();k++) {
				...
				if (newWebItem.getWebItemId() == existingWebItem.getWebItemId()) {
					...
					//Go ahead and in some cases you may found another Sub item that is not 
					//yet in the result tree
					if (existingWebItem.getChildTreeItems() == null) {
						existingWebItem.setChildTreeItems(new LinkedList<WebItem>());
					}
					
					this.checkForDuplicates(existingWebItem.getChildTreeItems(), newWebItem.getChildTreeItems());
		...
		Collections.sort( webItemRootNodesWithPathSorted, new WebItemsComperator() );
	...
	private WebItemListDTO morphWebItemToWebItemListDTOWithPath(WebItem webItem) {
		try {
			...
			if (webItem.getChildTreeItems() != null && webItem.getChildTreeItems().size() > 0) {
				
				webItemListDTO.setChildItems(new LinkedList<WebItemListDTO>());
				
				for (WebItem childItem : webItem.getChildTreeItems()) {
					webItemListDTO.getChildItems().add(this.morphWebItemToWebItemListDTOWithPath(childItem));
				}
	...
	/* (non-Javadoc)
	 * @see org.i4change.app.remote.IWebsiteService#getHelpMasterRoot(java.lang.String)
	 */
	public WebItemDTO getHelpMasterRoot(String sid) {
		try {
			
			return this.morphWebItemToWebItemDTO(this.webItemDaoImpl.getHelpMasterRoot());
