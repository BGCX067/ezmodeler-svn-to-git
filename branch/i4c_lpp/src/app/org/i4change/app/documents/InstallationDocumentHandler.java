...
public class InstallationDocumentHandler {
	...
	public static void createDocument(String filePath, Integer stepNo) throws Exception {
	...
	public static int getCurrentStepNumber(String filePath) throws Exception{
