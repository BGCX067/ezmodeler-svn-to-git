...
public class MailHandler {
	 ...
	 * @return
	 */
	public static String sendMail(String toEmail, String subj, String message, String filePath) {
		try {
			...
			return send(smtpServer, smtpPort, to, from, subject, body, emailUsername, emailUserpass, filePath);
		} catch (Exception ex) {
...
//	}
	 ...
	 * @return
	 */
	public static synchronized String send(String smtpServer, String smtpPort, String to, String from,
