...
<br>
<center>
<font size=2 color=black face=Verdana><b>Use The Default Sandbox API Profile Or Enter Your Own Profile</b></font>
<br><br>
<b><font color="FF0000">NOTE: Production code should NEVER expose API credentials in any way! They must be managed securely in your application.</font></b>
<br><br>
To generate a Sandbox API Certificate, follow these steps: <a href="https://www.paypal.com/IntegrationCenter/ic_certificate.html#step1" target="_blank">API Certificate</a></b>
<br><br>
...
<table width="700">
	...
	<tr> 
		<td colspan=3 align=center><br><b>Or enter yourt own profile...</b></td> 
	</tr>
	<tr>
		<td align="right"><font size=2 color=black face=Verdana><b>API Credentials:</b></font>
		<td>
			<input type="radio" name="api-type" value="tokens" checked onclick="onClick('tokens');">API Signature<br>
			<input type="radio" name="api-type" value="cert" onclick="onClick('cert');">API Client-Side SSL Certificate<br>
		</td>
	</tr>
	<tr>
		<td align="right"><font size=2 color=black face=Verdana><b>API Username:</b></font><br><font size=1 color=black face=Verdana>(ex: my_account_api1.paypal.com)</font></td>
