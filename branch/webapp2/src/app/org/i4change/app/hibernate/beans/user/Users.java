...
public class Users {
    ...
    //do not show in the List of possible assignee's, this is usefull if you have multiple Admins/Moderators, but don' want
    //to show them on the List
     ...
     * class = "org.i4change.app.hibernate.beans.domain.Organisation_Users"
     * @hibernate.key 
     * column = "user_id"
     */	
	...
	public Map getUserPropsAsObject() {
		return userPropsAsObject;
	}
	public void setUserPropsAsObject(Map userPropsAsObject) {
