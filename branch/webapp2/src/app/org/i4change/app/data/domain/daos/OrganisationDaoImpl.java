...
public class OrganisationDaoImpl {
	...
	private static OrganisationDaoImpl instance = null;
	...
	public static synchronized OrganisationDaoImpl getInstance() {
		if (instance == null) {
			instance = new OrganisationDaoImpl();
		}
		return instance;
	}
...
//	}
	 ...
	 * @param user_id
	 */
	public Long addOrganisationWithMap(String orgname, long user_id, Map orgPatternsMap) {
		try {
	...
	public SearchResult getOrganisations(int start ,int max, String orderby, boolean asc) {
		try {
			...
			sresult.setResult(this.getOrganisationsList(start, max, orderby,asc));
			return sresult;
		} catch (HibernateException ex) {
...
//	}	
	...
	public Long updateOrganisation(long organisation_id, String orgname, 
			long users_id, Map orgPatternsMap){
		try {			
	...
	private Long updateOrganisationUsersByHashMap(Organisation org , LinkedHashMap users, long insertedby){
		try {
			...
			List usersStored = OrganisationUserDaoImpl.getInstance().getUsersByOrganisationId(org.getOrganisation_id());
