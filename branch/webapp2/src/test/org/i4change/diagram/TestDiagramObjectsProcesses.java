...
public class TestDiagramObjectsProcesses extends TestCase {
...
//												getDiagramObjectsProcesesByMax(organization_id, start, max);
//		
//			SearchResult sresult = new SearchResult();
//			sresult.setObjectName(DiagramObject.class.getName());
//			sresult.setRecords(DiagramObjectServiceDaoImpl.getInstance().selectMaxDiagramObjectsProceses(organization_id));
