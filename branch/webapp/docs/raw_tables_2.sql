...
CREATE SCHEMA IF NOT EXISTS `develop` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `develop`;

-- -----------------------------------------------------
-- Table `develop`.`fieldvalues`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`fieldvalues` (
...
-- -----------------------------------------------------
-- Table `develop`.`error_type`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`error_type` (
  ...
  CONSTRAINT `fk_fieldvalues_id`
    ...
    REFERENCES `develop`.`fieldvalues` (`fieldvalues_id` ))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `develop`.`error_values`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`error_values` (
  ...
  CONSTRAINT `fk_error_type_id`
    ...
    REFERENCES `develop`.`error_type` (`errortype_id` ))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `develop`.`objecttype`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`objecttype` (
...
-- -----------------------------------------------------
-- Table `develop`.`baseobject`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`baseobject` (
  ...
  CONSTRAINT `fk_objecttype_id`
    ...
    REFERENCES `develop`.`objecttype` (`objecttype_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `develop`.`object`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`object` (
  ...
  CONSTRAINT `fk_baseobject_id`
    ...
    REFERENCES `develop`.`baseobject` (`baseobject_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `develop`.`diagramrevision`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`diagramrevision` (
...
-- -----------------------------------------------------
-- Table `develop`.`diagram`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`diagram` (
  ...
  CONSTRAINT `fk_diagramrevision_id`
    ...
    REFERENCES `develop`.`diagramrevision` (`diagramrevision_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `develop`.`markercategory`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`markercategory` (
...
-- -----------------------------------------------------
-- Table `develop`.`objectmarker`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`objectmarker` (
  ...
  CONSTRAINT `fk_markercategory_id`
    ...
    REFERENCES `develop`.`markercategory` (`markercategory_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `develop`.`diagram_object`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`diagram_object` (
  ...
  CONSTRAINT `fk_diagram_id`
    ...
    REFERENCES `develop`.`diagram` (`diagram_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_object_id`
    FOREIGN KEY (`object_id` )
    REFERENCES `develop`.`object` (`object_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_objectmarker_id`
    FOREIGN KEY (`objectmarker_id` )
    REFERENCES `develop`.`objectmarker` (`objectmarker_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `develop`.`emails`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`emails` (
...
-- -----------------------------------------------------
-- Table `develop`.`states`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`states` (
...
-- -----------------------------------------------------
-- Table `develop`.`adresses`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`adresses` (
  ...
  CONSTRAINT `FKCE8EE5A467466E58`
    ...
    REFERENCES `develop`.`states` (`state_id` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
-- -----------------------------------------------------
-- Table `develop`.`adresses_emails`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`adresses_emails` (
  ...
  CONSTRAINT `fk_email_id`
    FOREIGN KEY (`mail_id` )
    REFERENCES `develop`.`emails` (`mail_id` ),
  CONSTRAINT `fk_adresses_id`
    FOREIGN KEY (`adresses_id` )
    REFERENCES `develop`.`adresses` (`adresses_id` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
-- -----------------------------------------------------
-- Table `develop`.`phones`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`phones` (
...
-- -----------------------------------------------------
-- Table `develop`.`adresses_phones`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`adresses_phones` (
  ...
  INDEX FKADRESSESPHONES (`adresses_id` ASC) ,
  INDEX FKPHONESADRESSES (`phone_id` ASC) ,
  CONSTRAINT `FKADRESSESPHONES`
    FOREIGN KEY (`adresses_id` )
    REFERENCES `develop`.`adresses` (`adresses_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FKPHONESADRESSES`
    FOREIGN KEY (`phone_id` )
    REFERENCES `develop`.`phones` (`phone_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `develop`.`configuration`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`configuration` (
...
-- -----------------------------------------------------
-- Table `develop`.`organisation`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`organisation` (
...
-- -----------------------------------------------------
-- Table `develop`.`naviglobal`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`naviglobal` (
...
-- -----------------------------------------------------
-- Table `develop`.`navimain`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`navimain` (
  ...
  CONSTRAINT `FK7D543E5F363F971D`
    ...
    REFERENCES `develop`.`naviglobal` (`global_id` ))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `develop`.`navisub`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`navisub` (
  ...
  CONSTRAINT `FK6723D8DA8D368C1D`
    FOREIGN KEY (`main_id` )
    REFERENCES `develop`.`navimain` (`main_id` ))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `develop`.`usergroups`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`usergroups` (
...
-- -----------------------------------------------------
-- Table `develop`.`users_usergroups`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`users_usergroups` (
  ...
  CONSTRAINT `fk_users_id`
    FOREIGN KEY (`user_id` )
    REFERENCES `develop`.`users` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usergroups_id`
    FOREIGN KEY (`usergroup_id` )
    REFERENCES `develop`.`usergroups` (`usergroup_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `develop`.`userlevel`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`userlevel` (
...
-- -----------------------------------------------------
-- Table `develop`.`userdata`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`userdata` (
...
-- -----------------------------------------------------
-- Table `develop`.`salutations`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`salutations` (
...
-- -----------------------------------------------------
-- Table `develop`.`sessiondata`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`sessiondata` (
  `id` BIGINT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `develop`.`organisation_users`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`organisation_users` (
  ...
  CONSTRAINT `FKA4E46663E2E18827`
    ...
    REFERENCES `develop`.`organisation` (`organisation_id` ))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `develop`.`fieldlanguagesvalues`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `develop`.`fieldlanguagesvalues` (
  ...
  CONSTRAINT `fk_language_id`
    ...
    REFERENCES `develop`.`field_language` (`language_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
