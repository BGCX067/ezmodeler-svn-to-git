					...
					if (!moduleName.equals("nomodule")) {
						...
						if (isImage) {
							...
							if (userProfilePic) {
								...
								HashMap<String,Object> processThumb2 = GenerateThumbs.getInstance().generateThumb("_profile_", current_dir, completeName, 76);
						...
						hs.put("user", UserDaoImpl.getInstance().getUserById(users_id));
