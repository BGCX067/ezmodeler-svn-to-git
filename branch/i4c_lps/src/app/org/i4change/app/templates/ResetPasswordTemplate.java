...
public class ResetPasswordTemplate extends VelocityLoader{
	...
	public String getResetPasswordTemplate(String reset_link, Long default_lang_id){
        try {
        	...
        	Fieldlanguagesvalues labelid513 = Fieldmanagment.getInstance().getFieldByLabelNumberAndLanguage(new Long(513), default_lang_id);
        	Fieldlanguagesvalues labelid514 = Fieldmanagment.getInstance().getFieldByLabelNumberAndLanguage(new Long(514), default_lang_id);
        	Fieldlanguagesvalues labelid515 = Fieldmanagment.getInstance().getFieldByLabelNumberAndLanguage(new Long(515), default_lang_id);
        	Fieldlanguagesvalues labelid516 = Fieldmanagment.getInstance().getFieldByLabelNumberAndLanguage(new Long(516), default_lang_id);
