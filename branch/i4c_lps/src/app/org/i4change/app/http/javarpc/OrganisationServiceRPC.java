...
import org.i4change.app.remote.OrganisationService;
...
public class OrganisationServiceRPC extends BaseAdapterRPC {
	...
	public Organisation getOrganisationById(String SID, long organisation_id){
		try {
			...
			return organisationService.getOrganisationById(SID, organisation_id);
	...
	public Long checkOrganizationStatus(String SID, Long organization_id){
		try {
			...
			return organisationService.checkOrganizationStatus(SID, organization_id);
