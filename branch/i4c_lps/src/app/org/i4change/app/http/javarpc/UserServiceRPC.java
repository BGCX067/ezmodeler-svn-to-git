...
import org.i4change.app.remote.UserService;
...
public class UserServiceRPC extends BaseAdapterRPC {
	...
	public List getUserSalutations(String SID, int language_id){
		try {
	...
	public List searchUser(String SID, String searchcriteria ,String searchstring, int max, int start, String orderby, 
			boolean asc){
		try {
	...
	public UserSidebarProperty getUserSidebarPropertyByDiagram(String SID, 
			Long diagramNo){
		try {
