	...
	protected Template handleRequest(HttpServletRequest request,
		...
		try {
			...
			if (command.equals("doBuy")) {
				...
				TransactionPaypal transaction = TransactionPaypalDaoImpl.getInstance().getTransactionTransactionById(i4change_transactionId);
				...
				if (!ppresponse.getAck().equals(AckCodeType.Success) && 
					...
					TransactionPaypalDaoImpl.getInstance().addAndUpdateTransaction(i4change_transactionId, transactionId, 
				...
				TransactionPaypal transaction = TransactionPaypalDaoImpl.getInstance().getTransactionTransactionById(transactionId);
